...
const routesWithoutMenu = ['/login', '/register', '/recovery-password'];
const loggoutRoutes = ['/login', '/register', '/recovery-password']

const firebaseConfig = {
  apiKey: "AIzaSyAAQrkx0DzKN3U9YxXIbX64zMhYbfNMql0", //essa caceta não tá funcionando dentro do .env verificar depois o que tá acontecendo
