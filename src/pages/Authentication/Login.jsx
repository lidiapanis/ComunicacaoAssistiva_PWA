...
const Login = ({ setCurrentPath, loggoutRoutes, firebaseApp }) => {
    ...
    return <>
            <AuthTopComponent title_page={'Bem vindo(a)!'} subtitle_page={'Aqui você encontra Comunicação Alternativa e Ampliada'}/>
            <BoxComponent
                component="div"
            ...
            <StackComponent sx={{mt: 4, mb: 4}} alignItems={'center'}>
                <Link style={{
                    ...
                    fontWeight: '200 !important',
                    fontSize: 16
                }} to="/register">Cadastre-se para utilizar nossos serviços</Link>
            </StackComponent>
    </>
}
