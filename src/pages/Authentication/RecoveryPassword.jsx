...
const RecoveryPassword = ({ setCurrentPath, loggoutRoutes, firebaseApp }) => {
    ...
    return <>
            <AuthTopComponent title_page={'Esqueci minha senha'} subtitle_page={'Insira seu e-mail abaixo para recuperar sua senha.'}/>
            <BoxComponent
                component="div"
            ...
            <StackComponent sx={{mt: 4, mb: 4}} alignItems={'center'}>
                <Link style={{
                    ...
                    fontSize: 16
                }} to="/login">Lembrou sua senha? Efetue Login</Link>
            </StackComponent>
    </>
}
